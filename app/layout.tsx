...
export default async function RootLayout({ children, modal }: any) {
	...
	return (
        ...
        'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
			...
			<body>
				<noscript>
					<iframe
						src="https://www.googletagmanager.com/ns.html?id=GTM-PRPSXZS"
						height="0"
						width="0"
				...
				<App currentUser={currentUser!}>
					...
					<Suspense fallback={<AppLoading />}>{modal}</Suspense>
					<AppLoadingIndicator />
				</App>
			</body>
		</html>
